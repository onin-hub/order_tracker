...
if (isset($_POST['action']) && $_POST['action'] == "updaOStatusForDelivery") {
    ...
    $db->updateOrderByshipper($updateKey,$dateAndTimeFordelivery,$hubNumber);
...
if (isset($_POST['action']) && $_POST['action'] == "updateOStatusForDelivered") {
    ...
    $db->updateOrderOStatusToDelivered($updateKey,$dateAndTimeDelivered,$orderNumber);
...
if (isset($_POST['action']) && $_POST['action'] == "updateOStatusForVoidedAndRemark") {
    ...
    $db->updateOrderOStatusToVoided($updateKey,$orderNumber,$shipper_for_voided_date_time,$voidRemark);
