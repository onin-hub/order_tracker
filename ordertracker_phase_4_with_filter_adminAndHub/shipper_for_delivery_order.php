        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-4">
                    ...
                    <input type="text" name="" class="form-control dupOrderID" placeholder="orderId" value = "">
                    <input type="text" name="" class="form-control dupCustoName" placeholder="cusFullName" value = "">
                    <input type="text" name="" class="form-control getRating" placeholder="ratings" value = "">
                    <button type="submit" class="btn btn-success btn-sm" data-toggle="modal" data-target="#forDelivery_modal">Mark as delivered and save the rating</button>
                </div>
            </div>
        </div>
    </div>
