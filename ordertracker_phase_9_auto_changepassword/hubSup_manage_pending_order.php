...
<div class="container" style="margin-top:80px">
    ...
    <button type="button" class="btn btn-warning">
        Checking <span class="badge badge-light ml-2 checkingDataCount"><?php echo count($checkingData) ?></span>
        <!-- <span class="sr-only">unread messages</span> -->
    </button>

    <button type="button" class="btn btn-success">
        Delivery <span class="badge badge-light ml-2 deliveryDataCount"><?php echo count($deliveryData) ?></span>
        <!-- <span class="sr-only">unread messages</span> -->
    </button>
