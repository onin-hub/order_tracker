        ...
        <ul>
          ...
          <li class="drop-down"><a href="#">Order</a>
            <ul>
              ...
              <li><a href="admin_manage_pending_order.php">Pending Order</a></li>
              <li><a href="admin_manage_dispatch_order.php">Dispatched Order</a></li>
              <li><a href="admin_for_delivery_view.php">For Delivery Order</a></li>
              <li><a href="admin_delivered_order_view.php">Delivered Order (paid)</a></li>
              <li><a href="admin_cancelled_order_view.php">Cancelled Order (voided)</a></li>
            </ul>
          </li>
          <!-- multi dropdown menu -->
