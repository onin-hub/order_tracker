    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="shipper_dashboard.php">Dashboard</a></li>
          <li class="drop-down"><a href="#">Orders</a>
            <ul>
              <li><a href="shipper_dispatched_order.php">Dispatched Order</a></li>
              <li><a href="shipper_for_delivery_order.php">For Delivery Order</a></li>
