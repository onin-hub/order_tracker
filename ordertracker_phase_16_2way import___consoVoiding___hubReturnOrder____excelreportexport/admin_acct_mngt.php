    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body px-4">
                ...
                <div class="form-group">
                    <label class="form-group has-float-label">
                        <input type="text" name="" id="uContact" class="form-control" placeholder="Contact #" pattern="[1-9]{1}[0-9]{9}" maxlength="11">
                        <span>Contact #</span>
                    </label>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-4">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <label class="form-group has-float-label">
                            <input type="text" name="" id="euContact" class="form-control" placeholder="Contact #" pattern="[1-9]{1}[0-9]{9}" maxlength="11" required>
                            <span>Contact #</span>
                        </label>
                    </div>
