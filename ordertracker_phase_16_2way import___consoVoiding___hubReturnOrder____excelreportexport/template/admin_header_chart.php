...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <?php if ($_SESSION['logInAdminInfo'][6] == "Admin") { ?>
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li class="drop-down"><a href="#">Orders</a>
              <ul>
                <li><a href="admin_manage_pending_order.php">All Orders</a></li>
                <li><a href="admin_unconsolidate_order.php">Unconsolidate Orders</a></li>
                <li><a href="admin_not_available_prod.php">Out Of Stock History</a></li>
                <li><a href="admin_return_order_history.php">Returned Order History</a></li>
                <li><a href="admin_order_report.php">Order Reports</a></li>
              </ul>
            </li>
      ...
      <?php } else if ($_SESSION['logInAdminInfo'][6] == "Consolidator") { ?>
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li class="drop-down"><a href="#">Orders</a>
              <ul>
                ...
                <li><a href="admin_unconsolidate_order.php">Unconsolidate Orders</a></li>
                <li><a href="admin_not_available_prod.php">Out Of Stock History</a></li>
                <li><a href="admin_return_order_history.php">Return Order</a></li>
                <li><a href="admin_order_report.php">Order Reports</a></li>
              </ul>
            </li>
