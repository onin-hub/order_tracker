...
public function getOrderNumberDetails($orderNumber){
...
public function updateHubToUndefined($orderNumber){
    $updateKey = "undefined";

    $sql = "UPDATE `order_details` SET
    `hub_area` = :updateKey WHERE `order_number` = :order_number";
...
public function updateHubToNotCovered($orderNumber){
    $updateKey = "not covered";
...
public function updateHubZipcode($implodedZipcode,$hubArea){

    $sql = "UPDATE `hub_area_number` SET
    `zip_code` = :zip_code WHERE `hub_area` = :hub_area	";

    $stmt = $this->conn->prepare($sql);
    $stmt->execute(['zip_code' => $implodedZipcode,
                    'hub_area' => $hubArea]);

}

public function insertReturnHistoryDetails($order_date,
                                        $order_number,
                                        $c_fullname,
                                        $c_address_one,
                                        $c_address_two,
                                        ...
                                        $hub_area,
                                        $remarks){
    $sql = "INSERT INTO `return_history_order` (`order_date`, 
                                                `order_number`, 
                                                `c_fullname`, 
                                                `c_address_one`, 
                                                `c_address_two`, 
...
public function getReturnOrder($ugetUserHubNUmber){

    $sql = "SELECT * FROM `return_history_order` WHERE `hub_area` = :hub_area";
    $stmt = $this->conn->prepare($sql);
    $stmt->execute(['hub_area' => $ugetUserHubNUmber]);
