                    ...
                    foreach ($rOrderData as $row){
                        ...
                        if (in_array($order_number, $foNumberArray, TRUE)){
                            ...
                            <td>
                                ...
                                <a href="#" title="Return Order To Consolidator" class="text-danger return_tohub_Btn" data-toggle="modal" data-target="#cancelOrdermodal" orderNumber = "'.$row['order_number'].'"> <i class="fas fa-exchange-alt"></i>  </a>&nbsp;&nbsp;
