            ...
            <table id="dispatchOrderTableViewPerShipper" class="display responsive nowrap table table-striped table-bordered" width = "100%">
              ...
              <thead>
                  <tr class = "text-center">
                      ...
                      <th style="text-align: center;" >Phone number (primary)</th>
              ...
              <tbody>';
                    ...
                    foreach ($rOrderData as $row){
                        ...
                        if (in_array($order_number, $foNumberArray, TRUE)){
                            ...
                            <td style="text-align: center;">'.$row['c_fullname'].'</td>
                            <td style="text-align: center;">'.$row['c_pnumber_primary'].'</td>
            ...
            <table id="deliveredOrderTableViewPerShipper" class="display responsive nowrap table table-striped table-bordered" width = "100%">
              ...
              <thead>
                  <tr class = "text-center">
                      <th style="text-align: center;" >Id</th>
                      <th style="text-align: center;" >Order date</th>
                      <th style="text-align: center;" >Date deliver</th>
                      <th style="text-align: center;" >Order number</th>
                      <th style="text-align: center;" >Customer Name</th>
                      <th style="text-align: center;" >Phone number (primary)</th>
                      <th style="text-align: center;" >Action</th>
              ...
              <tbody>';
                    ...
                    foreach ($rOrderData as $row){
                        ...
                        if (in_array($order_number, $foNumberArray, TRUE)){
                            ...
                            $output .= '<tr  class = "text-center text-secondary">
                            <td style="text-align: center;" >'.$row['id'].'</td>
                            <td style="text-align: center;" >'.date("m/d/Y",strtotime($row['order_date'])).'</td>
                            <td style="text-align: center;" >'.date("m/d/Y H:i:s",strtotime($row['shipper_for_delivered_date_time'])).'</td>
                            <td style="text-align: center;" >'.$row['order_number'].'</td>
                            <td style="text-align: center;" >'.$row['c_fullname'].'</td>
                            <td style="text-align: center;" >'.$row['c_pnumber_primary'].'</td>
            ...
            <table id="cancelledOrderTableViewPerShipper" class="display responsive nowrap table table-striped table-bordered" width = "100%">
              ...
              <thead>
                  <tr class = "text-center">
                      <th style="text-align: center;" >Id</th>
                      <th style="text-align: center;" >Order date</th>
                      <th style="text-align: center;" >Date voided</th>
                      <th style="text-align: center;" >Order number</th>
              ...
              <tbody>';
                    ...
                    foreach ($rOrderData as $row){
                        ...
                        if (in_array($order_number, $foNumberArray, TRUE)){
                            ...
                            <td style="text-align: center;" >'.$row['id'].'</td>
                            <td style="text-align: center;" >'.date("m/d/Y",strtotime($row['order_date'])).'</td>
                            <td style="text-align: center;" >'.date("m/d/Y H:i:s",strtotime($row['shipper_for_voided_date_time'])).'</td>
                            <td style="text-align: center;" >'.$row['order_number'].'</td>
